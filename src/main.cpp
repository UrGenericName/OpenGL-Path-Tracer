...
int main() {
	...
	scene.meshCollection.push_back(new Mesh("models/room/green_wall.obj", new Material(DEFAULT_ALBEDO, "textures/concrete_normal.png", "textures/roughness_a.png"), glm::vec4(0.2f, 1.02f, 0.2f, 1.0f)));
	scene.link();
